...
public class TestesPessoasSelenium {
    ...
    //Links da Pagina de Pessoa

    //Teste com o título de página
    @Test
    @Order(1)
    public void titlePagePessoasTest() throws InterruptedException {
        driver.get(urlInicial);
        driver.findElement(By.id("gerenciaPessoas")).click();
    ...
    @Test
    @Order(2)
    public void urlPagePessoasTest() throws InterruptedException {
        driver.get(urlInicial);
    ...
    @Test
    @Order(4)
    public void urlPageDetalhesTest() throws InterruptedException {
        driver.get("https://erikaaraissaqwe.github.io/biblioteca-front/pages/pessoas/gerenciaPessoa.html");
        String urlEsperada = "https://erikaaraissaqwe.github.io/biblioteca-front/pages/pessoas/detalhesPessoa.html";
        driver.findElement(By.cssSelector("#tabela_pessoas > tbody > tr:nth-child(1) > " +
                "td:nth-child(2) > div > " +
                "a:nth-child(1)")).click();
        String urlAtual = driver.getCurrentUrl();
    ...
    public void titlePageDetalhesVoltarTest() throws InterruptedException {
        driver.get("https://erikaaraissaqwe.github.io/biblioteca-front/pages/pessoas/detalhesPessoa.html");
    ...
    public void titlePageEditarTest() throws InterruptedException {
        ...
        String titulo = driver.getTitle();
        Thread.sleep(2000);
        assertEquals("Edição de Pessoas", titulo);
    }
    ...
    public void urlPageEditarTest() throws InterruptedException {
        driver.get("https://erikaaraissaqwe.github.io/biblioteca-front/pages/pessoas/gerenciaPessoa.html");
        String urlEsperada = "https://erikaaraissaqwe.github.io/biblioteca-front/pages/pessoas/editarPessoa.html";
        driver.findElement(By.cssSelector("#tabela_pessoas > tbody > tr:nth-child(1) > " +
                "td:nth-child(2) > div > a:nth-child(3)")).click();
        String urlAtual= driver.getCurrentUrl();
        Thread.sleep(2000);
    ...
    public void titlePageEditarCancelarTest() throws InterruptedException {
        driver.get("https://erikaaraissaqwe.github.io/biblioteca-front/pages/pessoas/editarPessoa.html");
        driver.findElement(By.id("back")).click();
        String titulo = driver.getTitle();
        Thread.sleep(2000);
        assertEquals("Pessoas", titulo);
    ...
    public void urlPageDeleteConfirmTest() throws InterruptedException {
        driver.get("https://erikaaraissaqwe.github.io/biblioteca-front/pages/pessoas/gerenciaPessoa.html");
        String textEsperado = "Usuário Naowi Ferreira removido!";
        driver.findElement(By.cssSelector("#tabela_pessoas > tbody > tr:nth-child(1) > " +
    ...
    public void urlPageDeleteCancelTest() throws InterruptedException {
        driver.get("https://erikaaraissaqwe.github.io/biblioteca-front/pages/pessoas/gerenciaPessoa.html");
        String textEsperado = "Usuário Naowi Ferreira não foi removido!";
        driver.findElement(By.cssSelector("#tabela_pessoas > tbody > tr:nth-child(1) > " +
                "td:nth-child(2) > div > a:nth-child(2)")).click();
    ...
    public void titlePageCadastrarTest() throws InterruptedException {
        ...
        String titulo = driver.getTitle();
        Thread.sleep(2000);
        assertEquals("Cadastrar Pessoas", titulo);
    }
    ...
    public void urlPageCadastrarTest() throws InterruptedException {
        driver.get("https://erikaaraissaqwe.github.io/biblioteca-front/pages/pessoas/gerenciaPessoa.html");
        String urlEsperada = "https://erikaaraissaqwe.github.io/biblioteca-front/pages/pessoas/cadastrarPessoa.html";
        driver.findElement(By.cssSelector("#form > a")).click();
        String urlAtual = driver.getCurrentUrl();
        Thread.sleep(2000);
        assertEquals(urlEsperada, urlAtual);
